...
| `warning(slcp_create): .key_file "slcp.key" is mode 0644: readable by group/other` | The seed was copied or restored with a loose mode (`slcp key new` mints it 0600). The node starts anyway. | `chmod 600 slcp.key`. |
