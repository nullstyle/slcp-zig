...
test "oracle scenarios (§13.3)" {
    _ = @import("oracle_scenarios.zig");
} // pulls the stellar-core oracle-port tests into this bundle
test "byzantine fault-injection suite (§13.2)" {
    _ = @import("byzantine.zig");
} // Byzantine actor suite + seed matrix
test "restart safety (§13.1)" {
    _ = @import("restart.zig");
} // crash/restart own-log replay property
