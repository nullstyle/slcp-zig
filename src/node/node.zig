...
pub const InputItem = core.host.InputItem;
...
/// Transport-neutral ingress support, shared with foreign Engine hosts.
pub const HoldBuffer = core.host.HoldBuffer;
pub const Meta = core.host.Meta;
pub const envelopeMeta = core.host.envelopeMeta;
